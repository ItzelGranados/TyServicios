...
class CriterioResolucion(models.Model):
    ...
    ley_reglamento = models.ForeignKey(OrdenamientoJuridico, on_delete=models.PROTECT, null=True, blank=True,
                                       related_name="+")
...
class Requisito(models.Model):
    ...
    federal_estatal = models.ForeignKey(NivelDeGobierno, on_delete=models.PROTECT, null=True, blank=True,
                                        related_name="+")
    ley_reglamento = models.ForeignKey(OrdenamientoJuridico, on_delete=models.PROTECT, null=True, blank=True,
                                       related_name="+")
...
class DatoGeneral(models.Model):
    ...
    tipo = models.ForeignKey(Tipo, null=True, blank=True, on_delete=models.PROTECT,
                             verbose_name="Tipo de Servicio o Tramite")
    ...
    unidad_administrativa = models.CharField(max_length=250, null=True, blank=True,
                                             verbose_name="Unidad Administrativa")
    nivel_gobierno = models.ForeignKey(NivelDeGobierno, on_delete=models.PROTECT, null=True, blank=True,
                                       verbose_name="Nivel de gobierno")
    descripcion_principal = models.TextField(max_length=500, blank=True, null=True, verbose_name="Descripción")

    ambito_fundamento_origen = models.ForeignKey(Ambito, on_delete=models.PROTECT, blank=True, null=True,
                                                 related_name="Ámbito")
    tipo_fundamento_origen = models.ForeignKey(OrdenamientoJuridico, on_delete=models.PROTECT, blank=True, null=True,
                                               verbose_name="Tipo")
    ...
    numero_identificador = models.CharField(max_length=100, blank=True, null=True,
                                            verbose_name="Número de identificador del formato")
    modalidades = models.ManyToManyField(Modalidad, blank=True, related_name="Modalidad")

    ambito_fundamento_medio = models.ForeignKey(NivelDeGobierno, on_delete=models.PROTECT, blank=True, null=True,
                                                related_name="+")
    tipo_fundamento_medio = models.ForeignKey(OrdenamientoJuridico, on_delete=models.PROTECT, blank=True, null=True,
                                              related_name="+")
    ...
    fraccion_fundamento_medio = models.CharField(max_length=20, blank=True, null=True,
                                                 verbose_name="Fracción y/o inciso")
    ...
    moneda_pago = models.CharField(max_length=20, null=True, blank=True,
                                   verbose_name="Moneda en la que se realiza el pago")
    metodologia_monto = models.TextField(null=True, blank=True,
                                         verbose_name="Metodología utilizada para cálculo del monto")
    ...
    ambito_fundamento_derechos = models.ForeignKey(Ambito, on_delete=models.PROTECT, blank=True, null=True,
                                                   related_name="+")
    tipo_fundamento_derechos = models.ForeignKey(OrdenamientoJuridico, on_delete=models.PROTECT, blank=True, null=True,
                                                 related_name="+")
    ...
    a_fundamento_plazo_maximo = models.ForeignKey(Ambito, on_delete=models.PROTECT, null=True, blank=True,
                                                  related_name="+")
    t_fundamento_plazo_maximo = models.ForeignKey(OrdenamientoJuridico, on_delete=models.PROTECT, null=True, blank=True,
                                                  related_name="Tipo")
    ...
    ambito_fundamento_ficta = models.ForeignKey(Ambito, on_delete=models.PROTECT, null=True, blank=True,
                                                related_name="+")
    tipo_fundamento_ficta = models.ForeignKey(OrdenamientoJuridico, on_delete=models.PROTECT, null=True, blank=True,
                                              related_name="+")
    ...
    fundamento_prevencion = models.CharField(max_length=100, blank=True, null=True,
                                             verbose_name="Fundamento de la prevención")
    ...
    tipo_resolucion = models.ForeignKey(TipoResolucion, on_delete=models.PROTECT, null=True, blank=True,
                                        related_name="+")
    ...
    resolucion_requisito = models.BooleanField(default=False,
                                               verbose_name="¿La resolución es requisito de otro trámite?")
    liga_resolucion = models.CharField(max_length=200, blank=True, null=True,
                                       verbose_name="Liga de la resolución del trámite")

    persona_solicitante = models.ForeignKey(TipoSolicitante, on_delete=models.PROTECT, null=True, blank=True,
                                            verbose_name="¿Quién puede solicitarlo?")
    ...
    inspeccion = models.BooleanField(default=False, null=True, blank=True,
                                     verbose_name="¿Es necesaria una inspección y/o verificación?")
    ...
    ambito_inspeccion_verificacion = models.ForeignKey(Ambito, on_delete=models.PROTECT, null=True, blank=True,
                                                       related_name="+")
    tipo_inspeccion_verificacion = models.ForeignKey(Tipo, on_delete=models.PROTECT, null=True, blank=True,
                                                     related_name="+")
    ...
    titular = models.CharField(max_length=150, null=True, blank=True, verbose_name="titular")
    enlace = models.CharField(max_length=150, null=True, blank=True, verbose_name="enlace")
